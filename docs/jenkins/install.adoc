...
4. Configure the Gitea Org Item
  ...
  ***** NOTE: if setting up for TSSC integration testing use `main|release/.*|PR-\d` so that release integration testing branches will be detected
  ** Project Recognizers
  ...
  ** Branch names to build automatically: `main|release/.*|PR-\d`
  * Save
